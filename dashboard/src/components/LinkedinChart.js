...
const LinkedinCharts = ({settings}) => {
    const [data, setData] = useState([]);

    useEffect(() => {
      axios.post(`${process.env.REACT_APP_API_BASE_URL}/linkedin-chart`, {account: settings["linkedinName"]})
    .then(res => {
      setData(res.data);
    })
    ...
    <div className="charts--container">
      <div className="charts">
        <div className="chart--title">
          ...
          <Tooltip title={
              <div>
                <p>Topics are generated from posts by ChatGPT.</p>
                <br/>
      ...
      <div className="charts">
        <div className="chart--title">
          ...
          <Tooltip title= {
            <div>
              <p>Sentiments are calculated from the sum of all of the comments on a post divided by the total number of comments on that post.</p>
              <br/>
