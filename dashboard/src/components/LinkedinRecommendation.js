...
const LinkedinRecommendations = ({settings}) => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          const res = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/recommendations`, {account: settings["linkedinName"], platform: "linkedin"});
